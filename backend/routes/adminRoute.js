...
const { createAdmin, loginAdmin, logout, getAllUserDetails, getSingleUserDetail, updateUserRole, deleteUser }=require("../controllers/adminController");
...
router.route("/admin/users/all").get(isAuthenticatedAdmin, authorizeRoles("admin"), getAllUserDetails);
