...
export const registerConsumer = catchAsyncErrors(
...
// consumer login
export const loginConsumer = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { phoneNumber, password } = req.body;
    if (!phoneNumber || !password) {
      return next(new ErrorHandler("Please provide all the details", 400));
    }
    const consumer = await Consumer.findOne({ phoneNumber }).select(
      "+password"
    );
    if (!consumer) {
...
// consumer logout
export const consumerLogout = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getContactNumber = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
export const getSellersAndSearch = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getSellers = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getProductsOfUser = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getSellersByName = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const key = req.query.keyword
      ...
      : {};
    const apiFeature = new ApiFeatures(User.find(key), req.query).pagination(
      10
    );
    const sellers = await apiFeature.query;
    res.status(200).json({
...
export const getProductNamesandSearch = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const key = req.query.keyword
      ? {
          name: {
...
// tracker
export const addClickProduct = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
// clicks for sellers
export const addClickSeller = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
    const seller = await User.findById(id);
    if (!seller) {
...
export const getTopClickedProducts = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getTopClickedSellers = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getConsumerDetails = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
export const updateConsumerDetails = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
