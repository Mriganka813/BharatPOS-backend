...
export const addIncome = catchAsyncErrors(
...
export const getAllIncome = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const getSingleIncome = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const updateIncome = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
...
export const deleteIncome = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const income = await IncomeModel.findById(req.params.id);
